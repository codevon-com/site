<template>
  <BeatFitLegalLayout
    ...
    intro="Envie seu e-mail cadastrado no BeatFit para solicitar a exclusão da conta e dos dados associados."
  >
    <div class="grid gap-8 lg:grid-cols-[1fr_0.8fr]">
      ...
      <aside class="rounded-lg border border-[#EF1515]/15 bg-red-50 p-6">
        ...
        <p class="mt-4 text-sm leading-7 text-neutral-700">
          A solicitação será analisada e alguns dados podem ser retidos quando exigido por lei, segurança ou prevenção de fraude.
        </p>
      </aside>
    </div>
  </BeatFitLegalLayout>
