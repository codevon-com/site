  ...
  <section id="how-we-work" class="mx-auto max-w-screen-xl px-4 py-16 md:py-24">
    ...
    <div class="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="rounded-xl border border-border/60 p-6">
        ...
        <h3 class="font-medium">Roadmap</h3>
        <p class="mt-2 text-sm text-muted-foreground">We propose a lean milestone plan, team mix, and weekly cadence tailored to your goals.</p>
      </div>
      <div class="rounded-xl border border-border/60 p-6">
